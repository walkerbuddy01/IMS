...
const AddProductDialog = ({ open, onOpenChange }: AddProductDialogProps) => {
  ...
  const [newFieldType, setNewFieldType] = useState<
    "text" | "number" | "select"
  >("text");
  const { mutate, isSuccess, isError, error } = useCreateProduct();
        ...
        <div className="space-y-6 py-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={setSelectedPaymentTerms}
                >
                  <SelectTrigger>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2 md:col-span-2">
                <Label htmlFor="freight">Freight Options</Label>
                <div className="flex flex-wrap gap-2">
                  {freightOptions.map((option) => (
                    <Button
                      ...
                      type="button"
                      variant={
                        selectedFreight.includes(option) ? "default" : "outline"
                      }
                      size="sm"
                      className={
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="cogs">Cost of Goods (COGS) ($)</Label>
                <Input
                  id="cogs"
                  type="number"
                  min="0"
          ...
          <div className="border-t pt-4 mt-2">
            ...
            <p className="text-xs text-gray-500 mt-1">
              Add custom fields for additional product attributes like color,
              size, material, etc.
            </p>
          </div>
        </div>
